...
def _build_scheduled_tasks() -> Dict[str, ScheduledTask]:
    ...
    try:
        ...
        logger.warning("Scheduler scraper imports unavailable: %s", exc)

    return tasks


SCHEDULED_TASKS: Dict[str, ScheduledTask] = _build_scheduled_tasks()
